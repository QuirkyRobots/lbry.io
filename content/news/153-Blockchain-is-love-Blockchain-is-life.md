...
# The Status Quo
In Part 1, we covered how existing tech companies demonstrate active hostility towards users. If haven't read this or are not already convinced of this problem, [start here](https://lbry.com/news/why-do-tech-giants-abuse-their-users).
...
Want to join us? You can start by [downloading the LBRY app](http://lbry.com/get), trying it out, and letting us know if you have any questions or suggestions to improve it. You can also [join our chat](http://chat.lbry.com/) or consider a [more committed relationship](http://lbry.com/join-us). Together, we can build a better, freer internet.
